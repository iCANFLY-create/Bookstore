...
public class BookDAO {
	...
	public List<BookExtends> selectBoardList(Connection conn, String category) {
	...
	public List<BookExtends> selectBoardList(Connection conn, int cPage, int numPerPage, String category) {
		List<BookExtends> list = null;
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		String sql ="";
...
//	public String makingAuthorCode(Connection conn) {
//		String authorCode="";
//		PreparedStatement pstmt = null;
//		String sql = prop.getProperty("makingAuthorCode");
//		ResultSet rset = null;
//		
//		try {
//			pstmt = conn.prepareStatement(sql);
