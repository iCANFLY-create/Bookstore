...
public class BookService {
	...
	public List<BookExtends> selectBoardList(String category) {
		...
		List<BookExtends> list = bookDAO.selectBoardList(conn, category);
		close(conn);
		return list;
	}

	public List<BookExtends> selectBoardList(int cPage, int numPerPage, String category) {
		Connection conn = getConnection();
		List<BookExtends> list = bookDAO.selectBoardList(conn, cPage, numPerPage, category);
		close(conn);
		return list;
	}
...
//			authorCode = bookDAO.makingAuthorCode(conn);
//		} 
		close(conn);
